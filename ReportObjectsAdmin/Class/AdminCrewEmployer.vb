Public Class AdminCrewEmployer

    Public MainReport As New rptAdminCrewEmployer
    ...
    Public Sub New(ByRef REPORT_DETAIL As ReportDetail)
        ...
        cSQL = "SELECT * FROM dbo.tblAdmEmp "
        ...
        BindData(MainReport.celCrewEmployer, "Text", Nothing, "Name")
