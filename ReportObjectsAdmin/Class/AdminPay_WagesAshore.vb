Public Class AdminPay_WagesAshore
    Public MainReport As New rptAdminPay_WagesAshore
    ...
    Public Sub New(ByRef REPORT_DETAIL As ReportDetail)
        ...
        cSQL = "SELECT * FROM (SELECT *, CASE WHEN DateType = 1 THEN 'Date Departed / Date Arrived' ELSE CASE WHEN DateType = 2 THEN 'Date Signed On / Off' ELSE '' END END as StartEndDate, CASE WHEN WageType = 1 THEN 'Earnings' ELSE CASE WHEN WageType = 2 THEN 'Deductions' ELSE '' END END as WageTypeDesc, CASE WHEN isnull(Prorata,0) = 1 THEN 'YES' ELSE 'NO' END as isProrata FROM dbo.tblAdmWageAsh) t "
