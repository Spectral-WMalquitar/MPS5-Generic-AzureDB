...
Public Class RptChecklistReport

    Private ReadOnly _mainReport As New ChecklistReport
    ...
    Public Sub New(ByVal db As SQLDB, ByVal sourceQuery As String)
        Try
            ...
            _mainReport.lblRank.Text = PlanChecklist.CrewSelected.RankName
            _mainReport.lblSurname.Text = PlanChecklist.CrewSelected.SurName
            _mainReport.lblFirstName.Text = PlanChecklist.CrewSelected.FirstName
            _mainReport.lblMiddleName.Text = PlanChecklist.CrewSelected.MiddleName
            _mainReport.lblVessel.Text = PlanChecklist.CrewSelected.VesselName
            _mainReport.lblDepartureDate.Text = PlanChecklist.CrewSelected.DepartureDate
            _mainReport.lblFlagRegistry.Text = PlanChecklist.CrewSelected.FlagRegistry
            _mainReport.lblJoiningPort.Text = PlanChecklist.CrewSelected.JoiningPort
            ...
            With _mainReport
                ...
                'BindData(.CommentAgeRequirement, "Text", Nothing, "DocStatus")
                'Vessel Type
                ...
                LoadDetailCompetence(_mainReport.DetailReport_AgeRequirements, "DocType = 'Age Requirement'", _compSource)
