Public Class rptPayHAReportCrewPerVsl
    ...
    Private Sub rptPayHAReportCrew_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
