...
Public Class clsCrewListAll_prin
    Private MainReport As New rptCrewListAll_prin
    ...
    Public Sub New(ByRef REPORT_DETAIL As ReportDetail)
        ...
        BindData(MainReport.celprin, "Text", Nothing, "PrinName")


        AddFieldsToGroupHeaderBand(MainReport.grphead, "PrinName", FieldSortOrder.None)
