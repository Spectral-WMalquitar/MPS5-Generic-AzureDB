...
Public Module mdEncryptDecrypt
    ...
    Public Sub WriteRegLicensing(ByVal ckey As String, ByVal cVal As String, Optional ByVal useEncryption As Boolean = True)
        Try
    ...
    Public Function GetRegLicensing(ByVal ckey As String, Optional ByVal useEncryption As Boolean = True) As String
    ...
    Public Function CreateReg() As Boolean
        ...
        If regFile Is Nothing Then 'check if the regFile Exist
            Try
                ...
                'CreateReg = True   'Fixed return value by tony20171028
                Return True
            Catch ex As Exception
                'CreateReg = False  'Fixed return value by tony20171028
                Return False
            End Try
        Else
            Return False
