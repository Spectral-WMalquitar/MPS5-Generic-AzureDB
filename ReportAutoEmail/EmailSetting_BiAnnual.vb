Public Class EmailSetting_BiAnnual
    ...
    Public Overrides Sub initControls()
        ...
        cboExecMonth2.Properties.DataSource = dtMonths
        cboStartMonth2.Properties.DataSource = dtMonths
    ...
    Private Sub cboExecMonth_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles cboExecMonth.EditValueChanged
        Dim val As Integer = cboExecMonth.EditValue + 6
        cboExecMonth2.EditValue = IIf(val > 12, val - 12, val)
        If IsNothing(cboStartMonth.EditValue) Then
            cboStartMonth.EditValue = cboExecMonth.EditValue
        End If
    End Sub

    Private Sub cboStartMonth_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles cboStartMonth.EditValueChanged
        Dim val As Integer = cboStartMonth.EditValue + 6
        cboStartMonth2.EditValue = IIf(val > 12, val - 12, val)
    End Sub
