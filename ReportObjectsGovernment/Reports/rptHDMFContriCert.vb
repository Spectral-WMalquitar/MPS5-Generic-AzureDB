Public Class rptHDMFContriCert
    ...
    Private Sub txtParagraph_BeforePrint(sender As Object, e As System.Drawing.Printing.PrintEventArgs) Handles txtParagraph.BeforePrint
        Me.txtParagraph.Text = "	This is to certify that " & MPSDB.GetConfig("NAME") & " with Pag-ibig No. " & MPSDB.GetConfig("HDMFNBR") & " " & _
                  "has remitted the following Pag-ibig Contribution for MR. " & UCase(Me.txtCrew.Text) & ", one of our " & _
                  "crew members, with Pag-ibig No. " & Me.txtCrewHDMFNo.Text & "." ' who was onboard the Vessel ELIXIR from 2/13/2016 " & _
        '"to 8/31/2016."
    End Sub
