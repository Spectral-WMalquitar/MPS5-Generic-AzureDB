...
Public Class SSSloanCert
    Public MainReport As New rptSSSloanCert
    ...
    Public Sub New(ByRef REPORT_DETAIL As Reports.ReportDetail)
        ...
        cSQL = "EXEC SP_Pay_SSS_loan_cert @IDNBR = '" & Replace(WhereList, "'", "") & "'"
        ...
        '            "has remitted the following SSS loanbution for MR. AARON, LEO AARON, one of our" & _
        ...
        With MainReport
            ...
            BindData(.txtCollectingBank, "Text", Nothing, "CollectingBank")
