...
Public Class MCRContriCert
    Public MainReport As New rptMCRContriCert
    ...
    Public Sub New(ByRef REPORT_DETAIL As Reports.ReportDetail)
        ...
        cSQL = "EXEC SP_Pay_MCR_Contri_cert @IDNBR = '" & Replace(WhereList, "'", "") & "'"
        ...
        With MainReport
            ...
            BindData(.txtCrewMCRNo, "Text", Nothing, "MCRno")
