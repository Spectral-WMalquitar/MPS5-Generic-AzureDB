...
Public Class PayAdvanceList
    ...
    Private Sub MainViewRowCellStyle(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs) Handles MainView.RowCellStyle
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        bListSelect = "SELECT * FROM dbo.frm_Pay_CA_list ORDER BY DatePrepared DESC,TypeName"
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "VesselName") & _
                 " - " & MainView.GetRowCellValue(MainView.FocusedRowHandle, "TypeName") & _
                 " - " & MainView.GetRowCellValue(MainView.FocusedRowHandle, "PortName") & _
                " - " & MainView.GetRowCellValue(MainView.FocusedRowHandle, "Ref")
        Else
            Return ""
        End If
    End Function
