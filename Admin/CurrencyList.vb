Public Class CurrencyList
    ...
    Private Sub MainViewnRowCellStyle(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs) Handles MainView.RowCellStyle
        ...
        ElseIf MainView.GetRowCellValue(e.RowHandle, "Ref") And MainView.FocusedRowHandle = e.RowHandle Then
            e.Appearance.BackColor = REQUIRED_SELECTED_COLOR
            e.Appearance.ForeColor = GRID_SELFONTCOLOR
        ElseIf MainView.GetRowCellValue(e.RowHandle, "Ref") Then
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        bListSelect = "SELECT * FROM dbo.frmAdmCurrList " & strFilter & " ORDER BY Ref DESC,Name ASC,SortCode ASC"
