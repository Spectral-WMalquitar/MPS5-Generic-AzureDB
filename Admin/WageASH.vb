Public Class WageASH

#Region "Easy Edit"
    Private FormName As String = "Admin Wage Ashore"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmWageAsh"

        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Wage Ashore Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, cboWageType, cboDateType}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Ashore Wage Item", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
