...
#Region "Easy Edit"
    Private FormName As String = "Admin Vessel Department"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmDept"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Vessel Department Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Department", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
