...
#Region "Easy Edit"
    Private FormName As String = "Admin Relation"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        ...
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Relation Details - " & strDesc)
        If Not bLoaded Then
            initControls()
            bLoaded = True
        End If
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Relation", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
            ...
            RefreshData()
            If info Then
                MsgBox(GetMessage(Type, True), MsgBoxStyle.Information, GetAppName)
            End If
        End If
    End Sub
    ...
    Public Overrides Sub DeleteData()
        ...
        If MsgBox("Are you sure want to delete the '" & strDesc & "'?", MsgBoxStyle.Question + vbYesNo + vbDefaultButton2, GetAppName) = MsgBoxResult.Yes Then
            If DB.isDeleteAllowed(Me.TableName, strID) Then
                LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Language Level", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
