Public Class VesselList
    ...
    Public Overrides Sub RefreshData()
        ...
        bListSelect = "SELECT * FROM dbo.frmAdmVslList ORDER BY Name ASC, SortCode ASC" 'Old Code
        'Dim userdatafilterstring As String = GetUserFilterString(, , "FKeyPrincipal", "FKeyFlt")
        'bListSelect = "SELECT * FROM dbo.frmAdmVslList " & _
        '              IIf(userdatafilterstring.Length > 0, "WHERE " & userdatafilterstring, "") & _
        '              "ORDER BY Name ASC, SortCode ASC"
        Me.MainGrid.DataSource = DB.CreateTable(bListSelect) 'OldCode
        'Me.MainGrid.DataSource = USER_INFO.getFilteredUserDataDT(UserDetail.FilteredUserDataTables.VesselAll)
