...
#Region "Easy Edit"
    Private FormName As String = "Admin Vessel Type"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmVslType"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Vessel Type Details - " & strDesc)
        ...
        Else
            ...
            cboFkeyVslGrp.EditValue = Trim(IfNull(blList.GetFocusedRowData("FKeyVslGrp"), ""))
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Vessel Type", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
    ...
    Private Sub initControls()
        ...
        cboFkeyVslGrp.Properties.DataSource = DB.CreateTable("SELECT * FROM dbo.VslGrpList ORDER BY Name ASC")
    End Sub

    Private Sub cboFkeyVslGrp_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles cboFkeyVslGrp.ButtonClick
