...
#Region "Easy Edit"
    Private FormName As String = "Admin Language Level"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tbladmRate"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Language Level Details - " & strDesc)
        ...
        If UCase(Trim(IfNull(blList.GetFocusedRowData("PKey"), "")).Substring(0, 3)) = "SYS" Then
