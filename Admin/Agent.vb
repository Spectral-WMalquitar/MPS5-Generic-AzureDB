...
#Region "Easy Edit"
    Private FormName As String = "Admin Travel Agent"
...
#End Region
    Public Overrides Sub RefreshData()
        TableName = "tblAdmTravAgent"
        MyBase.RefreshData()

        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Travel Agent Details - " & strDesc)
        SetDeleteCaption(Name, "Delete Agent")
        ...
        Else
            ...
            Me.txtContact.Text = Trim(IfNull(blList.GetFocusedRowData("Contact"), ""))
            Me.txtContactNo.Text = Trim(IfNull(blList.GetFocusedRowData("ContactNo"), ""))
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, txtAbbrv, txtAddr, cboFKeyCntry, txtContact, txtContactNo}) Then
            'LASTUPDATED BY FORMAT
            'getusername() & <Description><FormName>
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Travel Agent", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName) 'neil
            If bAddMode Then
