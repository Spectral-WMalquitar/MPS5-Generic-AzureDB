...
#Region "Easy Edit"
    Private FormName As String = "Admin Garment Type"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmGarmentType"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Garment Type Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Garment Type", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
