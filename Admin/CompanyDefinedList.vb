Public Class CompanyDefinedList
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        bListSelect = "SELECT PKey, Name as 'Name', SortCode, BufferNo, FileTag, FKeyDocGroup " & _
                      "FROM dbo.tblAdmDocument WHERE FKeyDocGroup = 'SYSCOMPDEF' " & strFilter & " ORDER BY Name, SortCode"
    ...
    Public Overrides Function GetFocusedRowData(ByVal _columnname As String) As Object
        ...
        Catch ex As Exception
            LogErrors("--Error Generated in GetFocusedRowData() method in CompanyDefinedList.vb - Start --")
            LogErrors(ex.Message)
            LogErrors("--Error Generated in GetFocusedRowData() method in CompanyDefinedList.vb - End--")
    ...
    Public Overrides Sub SetSelection(ByVal id As String)
        ...
        Catch ex As Exception
            LogErrors("--Error Generated in SetSelection() method in CompanyDefinedList.vb - Start --")
            LogErrors(ex.Message)
            LogErrors("--Error Generated in SetSelection() method in CompanyDefinedList.vb - End--")
