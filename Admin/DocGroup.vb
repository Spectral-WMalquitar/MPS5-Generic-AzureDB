...
#Region "Easy Edit"
    Private FormName As String = "Admin Document Group"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmDocGroup"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Document Group Details - " & strDesc)
    ...
    Public Overrides Sub AddData()
        ...
        If Not bAddMode Then
            ...
            Me.txtSortCode.EditValue = GetSortCode(DB, Me.TableName, "SUBSTRING(PKey)<>'SYS'")
            BRECORDUPDATEDs = False
        End If
    End Sub
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Document Group", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
