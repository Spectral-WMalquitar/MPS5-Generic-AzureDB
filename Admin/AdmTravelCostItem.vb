Public Class AdmTravelCostItem

#Region "Easy Edit"
    Private FormName As String = "Admin Travel Cost Item"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmTravelCostItem"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Travel Cost Items Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Travel Cost Item", 10, System.Environment.MachineName, txtName.EditValue, FormName)
