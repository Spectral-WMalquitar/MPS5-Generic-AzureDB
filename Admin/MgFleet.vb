Public Class MgFleet

#Region "Easy Edit"
    Private FormName As String = "Admin Fleet Manager"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmMgFlt"

        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Fleet Manager Name - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtLName, txtFName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Fleet Manager", 10, System.Environment.MachineName, Util.ConcatWithSpaces(New Object() {txtFName.EditValue & _
