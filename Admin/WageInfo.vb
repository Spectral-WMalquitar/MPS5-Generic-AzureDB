...
#Region "Easy Edit"
    Private FormName As String = "Admin Other Wage Items"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmWageInfo"

        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Other Wage Details - " & strDesc)
        ...
        Else
            ...
            Me.cboFKeyDen.EditValue = Trim(IfNull(blList.GetFocusedRowData("FKeyDen"), ""))
            Me.cboFKeyPrd.EditValue = Trim(IfNull(blList.GetFocusedRowData("FKeyPrd"), ""))
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, cboDateType}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Other Wage Item", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
    ...
    Private Sub initControls()
        ...
        Me.cboFKeyDen.Properties.DataSource = DB.CreateTable("SELECT * FROM dbo.tblAdmWageDen ORDER BY Name ASC, SortCode ASC")
        Me.cboFKeyPrd.Properties.DataSource = DB.CreateTable("SELECT * FROM dbo.tblAdmWagePrd ORDER BY Name ASC, SortCode ASC")
    End Sub
    ...
    Private Sub cboFKeyDen_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles cboFKeyDen.ButtonClick
        ClearLookUpEdit(sender, e)
    End Sub

    Private Sub cboFKeyPrd_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles cboFKeyPrd.ButtonClick
        ClearLookUpEdit(sender, e)
    End Sub
End Class
