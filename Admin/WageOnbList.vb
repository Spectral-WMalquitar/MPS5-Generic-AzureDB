Public Class WageOnbList
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        bListSelect = "SELECT " & _
            "	* ," & _
            "	(CASE WHEN [isCAType]<>0 THEN " & _
            "	IIF(((SELECT COUNT(PKey) FROM dbo.tblPay_ONB WHERE FKeyWageOnb = a.PKey)>0) OR ((SELECT COUNT(PKey) FROM dbo.tblCA WHERE FKeyCAType = a.PKey )>0),1,0) " & _
            "		ELSE 0 " & _
            "	END) AS isCAInUse " & _
            " FROM dbo.tblAdmWageOnb a " & _
