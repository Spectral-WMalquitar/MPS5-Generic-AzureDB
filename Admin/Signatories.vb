...
#Region "Easy Edit"
    Private FormName As String = "Admin Signatory"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tbladmSign"
        MyBase.RefreshData()
        strRequiredFields = "txtLName,txtFName;txtPosition"
        If Not bLoaded Then
            initControls()
            bLoaded = True
        End If
        ...
        Else
            ...
            Me.txtPosition.Text = Trim(IfNull(blList.GetFocusedRowData("Position"), ""))
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtLName, txtFName, txtPosition}) Then
            'LASTUPDATED BY FORMAT
            'getusername() & <Description><FormName>
            'LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "", 10, System.Environment.MachineName, Me.txtLName.EditValue, FormName) 'neil	'tony20160719
            Dim cDataDescription As String = Util.ConcatWithSpaces(New Object() {txtFName.EditValue, txtMName.EditValue, txtLName.EditValue})
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Signatories", 10, System.Environment.MachineName, txtFName.EditValue & " " & txtMName.EditValue & " " & txtLName.EditValue, FormName)
            If bAddMode Then
    ...
    Public Overrides Sub DeleteData()
        ...
        If MsgBox("Are you sure want to delete the '" & strDesc & "'?", MsgBoxStyle.Question + vbYesNo + vbDefaultButton2, GetAppName) = MsgBoxResult.Yes Then
            If DB.isDeleteAllowed(Me.TableName, strID) Then 'Check if the record is in use or a system data
                Dim cDataDescription As String = Util.ConcatWithSpaces(New Object() {txtFName.EditValue, txtMName.EditValue, txtLName.EditValue})
                LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Signatories", 10, System.Environment.MachineName, cDataDescription, FormName)
    ...
    Private Sub initControls()
        ...
        'TblAdmCntryTableAdapter.Fill(MPSDataSet.tblAdmCntry)
        'TblAdmCntryBindingSource.Sort() = "Name ASC,SortCode ASC"
    End Sub
