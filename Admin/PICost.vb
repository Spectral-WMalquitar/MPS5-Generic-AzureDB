...
#Region "Easy Edit"
    Private FormName As String = "Admin P&I Cost"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmPICst"
        strRequiredFields = "txtName"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "P&&I Cost Details - " & strDesc)
        If Not bLoaded Then
            initControls()
            bLoaded = True
        End If
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "P&I Cost", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
