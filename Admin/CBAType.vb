Public Class CBAType

#Region "Easy Edit"
    Private FormName As String = "Admin CBA Type"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmCBAType"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "CBA Type Details - " & strDesc)
        ...
        Else
            ...
            Me.txtUnionName.Text = Trim(IfNull(blList.GetFocusedRowData("UnionName"), ""))
            Me.txtCompany.Text = Trim(IfNull(blList.GetFocusedRowData("Company"), ""))
            Me.txtExpiryDate.Text = Trim(IfNull(blList.GetFocusedRowData("ExpiryDate"), ""))
    ...
    Public Overrides Sub SaveData()
        ...
        LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "CBA Type", 10, System.Environment.MachineName, txtName.EditValue, FormName)

        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, txtAbbrv}) Then
            If bAddMode Then
    ...
    Public Overrides Function CheckValidateFields(Optional showMsg As Boolean = True) As Boolean
        ...
        If res = MsgBoxResult.Yes Then
            If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, txtAbbrv}, showMsg) Then
                If bAddMode Then
                    If CheckDuplicate(Me.TableName, New DevExpress.XtraEditors.TextEdit() {txtName, txtAbbrv}) Then
                        flag = False
                        ALLOWNEXTS = flag
    ...
    Public Overrides Sub DeleteData()
        ...
        If MsgBox("Are you sure want to delete the '" & strDesc & "'?", MsgBoxStyle.Question + vbYesNo + vbDefaultButton2, GetAppName) = MsgBoxResult.Yes Then
            If DB.isDeleteAllowed(Me.TableName, strID) Then 'Check if the record is in use or a system data
                LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Airline", 10, System.Environment.MachineName, txtName.EditValue, FormName)
    ...
    Private Sub txtExpiryDate_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles txtExpiryDate.ButtonClick
