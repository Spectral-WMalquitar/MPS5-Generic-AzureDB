Public Class CertLimit
#Region "Easy Edit"
    Private FormName As String = "Admin Certificate Limit"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tbladmLimit"
        strRequiredFields = "txtName"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Certificate Limit Details - " & strDesc)
        If Not bLoaded Then
            initControls()
            bLoaded = True
        End If
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Certificate Limit", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
