...
#Region "Easy Edit"
    Private FormName As String = "Admin Rank Group"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmRankGrp"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Rank Group Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Rank Group", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
