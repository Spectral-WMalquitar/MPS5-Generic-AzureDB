Public Class UniformIssueType

#Region "Easy Edit"
    Private FormName As String = "Admin Uniform Issue Type"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmUniformIssueType"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Uniform Issue Type Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Uniform Issue Type", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
