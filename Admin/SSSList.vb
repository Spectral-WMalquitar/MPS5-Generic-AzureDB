Public Class SSSList
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        bListSelect = "SELECT * FROM dbo.frmAdmSSSList ORDER BY Salary ASC"
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            ...
            Return "From [" & Format(IfNull(MainView.GetRowCellValue(MainView.FocusedRowHandle, "Salary"), 0), "n2") & "] to [" & Format(IfNull(MainView.GetRowCellValue(MainView.FocusedRowHandle, "SalaryTo"), 0), "n2") & "]"
        Else
            Return ""
        End If
    End Function
