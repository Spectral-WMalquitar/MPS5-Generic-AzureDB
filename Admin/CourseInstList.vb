Public Class CourseInstList
    ...
    Public Overrides Sub RefreshData()
        ...
        'Fill data
        bListSelect = "SELECT ci.*,cntry.Name as Country FROM dbo.tblAdmCourseInst ci " & _
            " LEFT JOIN dbo.tblAdmCntry cntry ON ci.FKeyCntry = cntry.PKey " & _
            " ORDER BY ci.Name ASC, ci.SortCode ASC"
