...
#Region "Easy Edit"
    Private FormName As String = "Admin Capacity"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmCapacity"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Capacity Details - " & strDesc)
        ...
        Else
            ...
            Me.txtRegulation.Text = Trim(IfNull(blList.GetFocusedRowData("Regulation"), ""))
    ...
    Public Overrides Sub AddData()
        ...
        If Not bAddMode Then
            ...
            AllowSaving(Name, True) 'Disable save button 
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, txtAbbrv}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Capacity", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
