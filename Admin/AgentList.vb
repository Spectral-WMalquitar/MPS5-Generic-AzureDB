Public Class AgentList
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        bListSelect = "SELECT * FROM tblAdmTravAgent ORDER BY Name ASC, SortCode ASC"
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 And (Not (MainView.GetRowCellValue(MainView.FocusedRowHandle, "Name") Is DBNull.Value)) Then
