...
#Region "Easy Edit"
    Private FormName As String = "Admin Fleet"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        ...
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Fleet Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, txtAddr, txtAbbrv, cboFKeyCntry}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Fleet", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
