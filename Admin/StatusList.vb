Public Class StatusList
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        bListSelect = "SELECT *,(CASE WHEN StatType = 1  THEN 'ONBOARD' WHEN StatType = 2 THEN 'SIGNOFF Reason' WHEN StatType=3 THEN 'ASHORE' END) as StatTypeName, LeaveType,CONVERT(BIT,CASE WHEN SUBSTRING(PKey,0,4)= 'SYS' THEN 1 ELSE 0 END ) as isSysRecord FROM dbo.tblAdmStat ORDER BY Name,StatType, SortCode ASC"
    ...
    Private Sub MainView_CustomColumnDisplayText(sender As Object, e As DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs) Handles MainView.CustomColumnDisplayText
        'If e.Column.FieldName = "StatType" Then
        '    Select Case e.Value
        '        Case "1"
        '            e.DisplayText = "ONBOARD"
        '        Case "2"
        '            e.DisplayText = "SIGN OFF"
        '            'Case "3"
        '            '    e.DisplayText = "As hore"
        '    End Select
        'End If
    End Sub
