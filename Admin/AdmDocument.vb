...
#End Region
    ...
    Public Overrides Sub RefreshData()
        ...
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Document Type Details - " & strDesc)
        strRequiredFields = "txtName;cboFKeyDocGroup;txtFileTag"
        If Not bLoaded Then
            initControls()
            bLoaded = True
        End If
        ...
        Else
            ...
            Me.cboFKeyDocGroup.EditValue = Trim(IfNull(blList.GetFocusedRowData("FKeyDocGroup"), ""))
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, cboFKeyDocGroup, txtFileTag}) Then
            'LASTUPDATED BY FORMAT
            'getusername() & <Description><FormName>
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Document Type", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
    ...
    Private Sub initControls()
        ...
        Me.cboFKeyDocGroup.Properties.DataSource = DB.CreateTable("SELECT PKey,Name FROM dbo.tblAdmDocGroup WHERE SUBSTRING(PKey,1,3)<> 'SYS' ORDER BY Name ASC")
    End Sub

    Private Sub cboFKeyDocGroup_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles cboFKeyDocGroup.ButtonClick
