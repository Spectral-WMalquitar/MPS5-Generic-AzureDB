Public Class WagePrd

#Region "Easy Edit"
    Private FormName As String = "Admin Calculation Period"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmWagePrd"

        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Calculation Period Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Calculation Period", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
    ...
    Public Overrides Sub DeleteData()
        ...
        If MsgBox("Are you sure want to delete the '" & Trim(IfNull(blList.GetFocusedRowData("Name"), "")) & "'?", MsgBoxStyle.Question + vbYesNo + vbDefaultButton2, GetAppName) = MsgBoxResult.Yes Then
