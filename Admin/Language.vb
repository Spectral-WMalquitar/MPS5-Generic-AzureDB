...
#Region "Easy Edit"
    Private FormName As String = "Admin Language"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tbladmLang"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Language Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Language", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
    ...
    Private Sub Language_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
