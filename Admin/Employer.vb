...
#Region "Easy Edit"
    Private FormName As String = "Admin Crew Employer"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tbladmEmp"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Crew Employer Details - " & strDesc)
        strRequiredFields = "txtName;txtAbbrv;txtAddr;cboFKeyCntry"
        If Not bLoaded Then
            initControls()
            bLoaded = True
        End If
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName, txtAddr, txtAbbrv, cboFKeyCntry}) Then
            'LASTUPDATED BY FORMAT
            'getusername() & <Description><FormName>
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Crew Employer", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
