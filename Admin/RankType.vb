...
#Region "Easy Edit"
    Private FormName As String = "Admin Rank Type"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tbladmRankType"
        strRequiredFields = "txtName"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Rank Type Details - " & strDesc)
        If Not bLoaded Then
            initControls()
            bLoaded = True
        End If
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Rank Type", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
    ...
    Public Overrides Function CopyData() As String
        If Not bCopy Then
            CopyID = blList.GetID()
            bCopy = True
        End If
