Public Class CertFunc

#Region "Easy Edit"
    Private FormName As String = "Admin Certificate Function"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tbladmLicCertFunct"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Certificate Function Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Certificate Function", 10, System.Environment.MachineName, txtName.EditValue, FormName)
            If bAddMode Then
