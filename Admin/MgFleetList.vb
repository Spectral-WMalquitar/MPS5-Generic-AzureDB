Public Class MgFleetList
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        bListSelect = "SELECT * FROM dbo.tblAdmMgFlt ORDER BY LName ASC,FName ASC,SortCode ASC"
    ...
    Public Overrides Function GetDesc() As String
        If MainView.RowCount > 0 Then
            Return MainView.GetRowCellValue(MainView.FocusedRowHandle, "LName") & ", " & MainView.GetRowCellValue(MainView.FocusedRowHandle, "FName") & " " & MainView.GetRowCellValue(MainView.FocusedRowHandle, "MName")
        Else
            Return ""
        End If
    End Function
