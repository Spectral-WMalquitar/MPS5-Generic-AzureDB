Public Class AdmCashAdvancesList
    ...
    Public Overrides Sub RefreshData()
        ...
        'put data
        'bListSelect = "SELECT * FROM dbo.tblAdmCAType ORDER BY Name ASC,SortCode ASC"
        bListSelect = "SELECT * FROM dbo.tblAdmWageOnb WHERE isCAType <> 0 ORDER BY Name, SortCode"
