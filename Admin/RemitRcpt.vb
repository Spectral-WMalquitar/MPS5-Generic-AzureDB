Public Class RemitRcpt
#Region "Easy Edit"
    Private FormName As String = "Admin Remittance Receipt"
...
#End Region
    ...
    Public Overrides Sub RefreshData()
        TableName = "tblAdmWageRcpt"
        MyBase.RefreshData()
        Me.header.Text = IIf(strDesc = "New Record", strDesc, "Remittance Receipt Details - " & strDesc)
    ...
    Public Overrides Sub SaveData()
        ...
        If ValidateFields(New DevExpress.XtraEditors.TextEdit() {txtName}) Then
            ...
            LastUpdatedBy = clsAudit.AssembleLastUBy(USER_NAME, "Remittance Receipt", 10, System.Environment.MachineName, Me.txtName.EditValue, FormName)
            If bAddMode Then
