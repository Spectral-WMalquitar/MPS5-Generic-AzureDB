...
Public Class CrewWithSpecificCertificate

    Private MainReport As New rptCrewWithSpecificCertificate
    ...
    Public Sub New(ByRef REPORT_DETAIL As ReportDetail)
        ...
        'Select REPORT_DETAIL.FilterOption.GetFilterValue("Certificate Status")
        '    Case "Planned"
        ...
        cSQL = "Select * from Rpt_CrewWithDocRpt where FKeyDocGroup = 'SYSLICCERT' and " & IIf(MainReportFilter.Length > 0, MainReportFilter, "")
        ...
        'MsgBox(REPORT_DETAIL.FilterOption.GetFilterValue("Expiring"))
        ...
        AddFieldsToGroupHeaderBand(MainReport.GroupHeader_CertDocName, "CertDocName", REPORT_DETAIL.SortOption.GetSortValueCode("CertificateName"))
