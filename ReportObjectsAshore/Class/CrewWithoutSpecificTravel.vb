...
Public Class CrewWithoutSpecificTravel

    Private MainReport As New rptCrewWithoutASpecificTravel
    ...
    Public Sub New(ByRef REPORT_DETAIL As ReportDetail)
        ...
        cSQL = "Select * from Rpt_CrewWithoutDocRpt where FKeyDocGroup = 'SYSTRAVELDOC' and " & IIf(MainReportFilter.Length > 0, MainReportFilter, "")
