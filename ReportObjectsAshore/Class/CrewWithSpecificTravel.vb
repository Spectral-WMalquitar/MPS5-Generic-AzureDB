...
Public Class CrewWithSpecificTravel

    Private MainReport As New rptCrewWithSpecificTravel
    ...
    Public Sub New(ByRef REPORT_DETAIL As ReportDetail)
        ...
        cSQL = "Select * from Rpt_CrewWithDocRpt where FKeyDocGroup = 'SYSTRAVELDOC' and " & IIf(MainReportFilter.Length > 0, MainReportFilter, "")
