...
Public Class CrewWithSpecificCompanyDefinedDoc

    Private MainReport As New rptCrewWithSpecificCompanyDefinedDoc
    ...
    Public Sub New(ByRef REPORT_DETAIL As ReportDetail)
        ...
        cSQL = "Select * from Rpt_CrewWithDocRpt where FKeyDocGroup = 'SYSCOMPDEF' and " & IIf(MainReportFilter.Length > 0, MainReportFilter, "")
        ...
        AddFieldsToGroupHeaderBand(MainReport.GroupHeader_CertDocName, "CertDocName", REPORT_DETAIL.SortOption.GetSortValueCode("TravelName"))
