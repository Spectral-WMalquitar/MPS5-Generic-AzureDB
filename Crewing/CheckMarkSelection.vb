...
Namespace MPS5.DevExpress.XtraGrid.Selection
    ...
    Public Class GridCheckMarksSelection
        ...
        Protected Overridable Sub Attach(ByVal view As AdvBandedGridView)
            ...
            Try
                ...
                column.OptionsColumn.AllowSort = Global.DevExpress.Utils.DefaultBoolean.False
                ...
                column.UnboundType = Global.DevExpress.Data.UnboundColumnType.Boolean
            ...
            Catch ex As Exception
                LogErrors("--Error Generated in Attach() method in CheckMarkSelection.vb - Start --")
                LogErrors(ex.Message)
                LogErrors("--Error Generated in Attach() method in CheckMarkSelection.vb - End--")
        ...
        Protected Function GetCheckBoxWidth() As Integer
            Dim info As Global.DevExpress.XtraEditors.ViewInfo.CheckEditViewInfo = TryCast(edit.CreateViewInfo(), Global.DevExpress.XtraEditors.ViewInfo.CheckEditViewInfo)
            Dim width As Integer = 0
            GraphicsInfo.Default.AddGraphics(Nothing)
            Try
                width = info.CalcBestFit(GraphicsInfo.Default.Graphics).Width
            Catch ex As Exception
                LogErrors("--Error Generated in GetCheckBoxWidth() method in CheckMarkSelection.vb - Start --")
                LogErrors(ex.Message)
                LogErrors("--Error Generated in GetCheckBoxWidth() method in CheckMarkSelection.vb - End--")
        ...
        Protected Sub DrawCheckBox(ByVal g As Graphics, ByVal r As Rectangle, ByVal Checked As Boolean)
            Dim info As Global.DevExpress.XtraEditors.ViewInfo.CheckEditViewInfo
            Dim painter As Global.DevExpress.XtraEditors.Drawing.CheckEditPainter
            Dim args As Global.DevExpress.XtraEditors.Drawing.ControlGraphicsInfoArgs
            info = TryCast(edit.CreateViewInfo(), Global.DevExpress.XtraEditors.ViewInfo.CheckEditViewInfo)
            painter = TryCast(edit.CreatePainter(), Global.DevExpress.XtraEditors.Drawing.CheckEditPainter)
            info.EditValue = Checked
            info.Bounds = r
            info.CalcViewInfo(g)
            args = New Global.DevExpress.XtraEditors.Drawing.ControlGraphicsInfoArgs(info, New Global.DevExpress.Utils.Drawing.GraphicsCache(g), r)
            painter.Draw(args)
            args.Cache.Dispose()
        End Sub
