Namespace My
    ...
    Partial Friend Class MyApplication
        Private Sub MyApplication_Startup(ByVal sender As Object, ByVal e As Microsoft.VisualBasic.ApplicationServices.StartupEventArgs) Handles Me.Startup
            ShowCustomLoadScreen(GetType(MPS4.MPS4Splash_Crew))
            ...
            SQLServer = IfNull(GetIni("SERVER", True), String.Empty)
            SQLID = IfNull(GetIni("USERID", True), String.Empty)
            SQLPW = IfNull(GetIni("PASSWORD", True), String.Empty)
            'SQLServer = IfNull(GetReg("SERVER"), String.Empty)
            'SQLID = IfNull(GetReg("USERID"), String.Empty)
            'SQLPW = IfNull(GetReg("PASSWORD"), String.Empty)
            '-->
    ...
    Public Class QuickAccessClass

        Public Overridable Sub MyGlobalFunction()
