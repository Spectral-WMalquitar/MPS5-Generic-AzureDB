...
Public Class SOffDueToMedReason

    Private MainReport As New rptSOffDueToMedReason
    ...
    Public Sub New(ByRef REPORT_DETAIL As Reports.ReportDetail)
        ...
        cFilter = cFilter & " AND " & _
                          "NOT ss.fkeystatcode IN ('SYSAPP') " & _
                          "AND NOT ss.dateson is null " & _
                          "AND rn_SignOff = 1 " & _
                          "AND NOT ss.DateSOff is null " & _
                          "AND stat.IncludeMedHistory = 1 " & _
                          "AND ss.acttype = 'SEA' "
        ...
        cSQL = "SELECT		    crew.*, dept.name as RankDept, ss.*, rank.Abbrv as RankAbbrv " & _
