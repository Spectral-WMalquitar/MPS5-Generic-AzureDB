...
Public Class BiodataEssential

    Private MainReport As New rptBiodataEssential
    ...
    Public Sub New(ByRef REPORT_DETAIL As ReportDetail)
        ...
        Dim _SeaServiceDisplay As BiodataComplete.SeaServiceDisplay = BiodataComplete.SeaServiceDisplay.Grouped

        If IfNull(REPORT_DETAIL.FilterOption.GetFilterValue("Sea Service Display"), "").Equals("Continuous") Then
            _SeaServiceDisplay = BiodataComplete.SeaServiceDisplay.Continuous
        ElseIf IfNull(REPORT_DETAIL.FilterOption.GetFilterValue("Sea Service Display"), "").Equals("Grouped") Then
            _SeaServiceDisplay = BiodataComplete.SeaServiceDisplay.Grouped
        End If

        If _SeaServiceDisplay = BiodataComplete.SeaServiceDisplay.Grouped Then
        ...
        ElseIf _SeaServiceDisplay = BiodataComplete.SeaServiceDisplay.Continuous Then
